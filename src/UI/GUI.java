...
public class GUI extends JFrame implements ActionListener, MouseListener {
	...
	public GUI() {
		setTitle("QUẢN LÝ BÁN LINH KIỆN");
//		setResizable(false);
	...
	public JTabbedPane createTabbedPane() {
		...
		FrmLinhKien frmLinhKien = new FrmLinhKien();
		...
		JPanel pnlLinhKien = frmLinhKien.createPanelSanPham();
		...
		tabbedPane.addTab("LINH KIỆN", new ImageIcon("image/linhkien.png"), pnlLinhKien, "LINH KIỆN");
	...
	public JPanel createPanelTrangChu() {
		...
		NhanVien nv = nhanvien_dao.getTenNV(FrmDangNhap.getTaiKhoan());
